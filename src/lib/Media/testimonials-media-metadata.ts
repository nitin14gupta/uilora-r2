...
export const testimonialsMediaComponentsMetadata: Component[] = [
    {
        id: "clay-stack",
        name: "Clay Stack",
    ...
    },
    {
        ...
        whenToUse: "Perfect for edtech platforms, SaaS products, and Uilora pages that want a high-energy testimonial section that communicates scale and momentum.",
        bestPractices: "Keep the background dark — the wave and avatar effects lose impact on light backgrounds. Keep quotes under 40 words.",
        whyMatters: "Wave streams suggest connection and flow. When testimonials are embedded in a living visual system, readers feel they are joining something in motion.",
        faqs: [
            { question: "How do the avatars float?", answer: "Each avatar is a motion.div with animate={{ y: [0, -8, 0] }} on an infinite loop, staggered by index * 0.35s delay." },
            { question: "Can I add more testimonial cards?", answer: "Add items to the TESTIMONIALS array. For more than 3, switch the grid to grid-cols-2." },
            { question: "What is the arrow button in the middle card?", answer: "A navigation affordance for the active testimonial. Wire it to a modal or expanded view in your implementation." }
        ],
    },
    {
        id: "stat-split",
        ...
        whenToUse: "Built for fintech, banking, and SaaS products that need to pair human testimonials with quantitative proof.",
        bestPractices: "Use real portrait photography. Keep stats to 2–3 characters maximum so the number reads at a glance.",
        whyMatters: "Combining a human face with a hard number creates the highest-trust testimonial format. The face provides emotional resonance; the stat provides rational justification.",
        faqs: [
            { question: "How are the rows structured?", answer: "Each row is a flex container: photo | divider | quote | divider | stat. 1px borders create visual separation without heavy UI chrome." },
            { question: "Can I add more rows?", answer: "Add items to the TESTIMONIALS array and the layout extends automatically." },
            { question: "Is it mobile responsive?", answer: "On mobile the rows stack vertically — photo on top, quote below, stat as a bold accent line." }
        ],
    },
    {
        id: "trend-showcase",
        ...
        whenToUse: "Ideal for fashion e-commerce, lifestyle brands, and Uilora portfolio showcases that want testimonials embedded in an editorial layout.",
        bestPractices: "Use high-contrast fashion photography with warm tones to complement the cream/amber palette. Keep the quote short — the layout is the storytelling vehicle.",
        whyMatters: "Fashion consumers are visually driven. A testimonial surrounded by product imagery creates context — the endorsement feels like part of the product experience.",
        faqs: [
            { question: "How does the bento grid work?", answer: "Two flex rows with percentage-based width splits. Each panel is a flex child — proportions reflow naturally at different container widths." },
            { question: "Can I change the photos?", answer: "All image URLs are baked as module-level constants (PANEL_IMAGES). Fork the file and swap the URLs." },
            { question: "Is it mobile responsive?", answer: "On mobile the panels stack vertically in order: heading, main photo, quote, CTA, product image." }
        ],
    },
    {
        id: "proof-grid",
        ...
        whenToUse: "Ideal for SaaS platforms, website builders, and Uilora-powered landing pages that need to pair a large social-proof number with real customer quotes.",
        bestPractices: "Keep the STAT to 3–5 characters for maximum visual impact. Use 6–9 testimonial cards — the bottom fade naturally hides the last row, creating an infinite depth effect that invites scrolling.",
        whyMatters: "A single large number anchors the testimonial section with a quantitative claim that is impossible to ignore. Pairing it with real voices immediately validates the number, converting skeptics.",
        faqs: [
            { question: "How does the bottom fade work?", answer: "A CSS maskImage gradient fades the grid from fully visible at the top to transparent at the bottom, starting at 60% of the grid height." },
            { question: "Can I change the stat?", answer: "The STAT and STAT_LABEL are module-level constants at the top of the file. Fork the component and update them to match your product metrics." },
            { question: "Is it mobile responsive?", answer: "Yes. The header switches to a vertical stack on mobile. The grid collapses from 3 columns to 2 on tablet and 1 on mobile." }
        ],
    },
    {
        id: "founder-badge",
